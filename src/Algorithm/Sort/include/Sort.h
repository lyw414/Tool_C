...
#include <stdio.h>
#include "Sort_Func.h"
typedef bool ( *TSortFuncForSort ) ( void ** DataArray,size_t ArraySize,TCompareForSort compare_func);
...
typedef bool ( * TSortForSort ) ( struct _Sort * this, void ** DataArray,size_t ArraySize,TSortAlgorithmForSort SortAlgorithm);
